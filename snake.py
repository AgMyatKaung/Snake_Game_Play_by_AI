...
class SnakeGame:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_LEFT and self.direction != Direction.RIGHT:
                 ...
                 # Additional WASD keys for movement
    ...
    def _show_game_over_screen(self):
        game_over_text = font.render("Game Over! Score: " + str(self.score), True, WHITE)
        ...
        while self.game_over:
            ...
            self.display.fill(BLACK)
            self.display.blit(game_over_text, [self.w // 2 - 150, self.h // 2 - 50])
            restart_text = font.render("Press R to restart", True, WHITE)
            quit_text = font.render("Press Q to quit", True, WHITE)
            self.display.blit(restart_text, [self.w // 2 - 100, self.h // 2 + 20])
            self.display.blit(quit_text, [self.w // 2 - 100, self.h // 2 + 50])
            pygame.display.flip()
